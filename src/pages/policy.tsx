...
import herologo from '../assets/policy.jpg'
        ...
        <>
            ...
            <div className='text-container'>
                <div>
                    ...
                    <h3 style={{ color: 'rgb(211, 174, 95)', marginBottom: '0'  }}>Vilka uppgifter samlar vi in?</h3>
                    <p style={{marginTop: '4px'}}>
                        ...
                        via vår plattform kan vi be om ditt telefonnummer och
                        e-postadress för att underlätta kommunikationen och
                        slutföra proccessen.
                    </p>
                    <h3 style={{ color: 'rgb(211, 174, 95)', marginBottom: '0'  }}>Hur använder vi dina uppgifter?</h3>
                    <p style={{marginTop: '4px'}}>
                    ...
                    <h3 style={{ color: 'rgb(211, 174, 95)', marginBottom: '0'  }}>Säkerhet och skydd</h3>
                    <p style={{marginTop: '4px'}}>
                    ...
                    <h3 style={{ color: 'rgb(211, 174, 95)', marginBottom: '0'  }}>Samtycke</h3>
                    <p style={{marginTop: '4px'}}>
                    ...
                    <h3 style={{ color: 'rgb(211, 174, 95)', marginBottom: '0' }}>Dina rättigheter</h3>
                    <p style={{marginTop: '4px'}}>
                    ...
                    <h3 style={{ color: 'rgb(211, 174, 95)', marginBottom: '0'  }}>Kontaktinformation</h3>
                    <p style={{marginTop: '4px'}}>
