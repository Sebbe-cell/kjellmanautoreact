                ...
                <div className='modal-body'>
                    {isSubmitted ? (
                        <>
                            <div>
                                <p>
                                    ...
                                    reklamation. Vi förstår vikten av att lösa
                                    problemen med din bil så snabbt som möjligt.
                                    Vårt team kommer att arbeta hårt för att
                                    lösa ditt ärende och återkomma med en
                                    lösning inom en skälig tidsram.
                                </p>
                                <p>
                        ...
                        <>
                            ...
                            />
                            <FormInput
                                label={'Datum när problemet upptäcktes*'}
                                id={'Date'}
                                type='date'
                                ...
                                optionalInputStyle={{
                                    ...
                                    fontSize: errors.dateWhenErrorOccurred
                                        ? '16px'
                                        : '',
                                    textTransform: !errors.dateWhenErrorOccurred
                                        ? 'uppercase'
                                        : 'none'
                                }}
                                placeholder={
                            ...
                            />
                            <FormInput
                                label={'Mätarställning när problemet uppstod*'}
                                id={'MileageError'}
                                ...
                                value={
                                    initialValues.mileageWhenErrorOccurred === 0
                                        ? ''
                                        : initialValues.mileageWhenErrorOccurred
                                }
                                onChange={(e) => handleInputChange(e)}
                                ...
                                optionalInputStyle={{
                                    border: errors.mileageWhenErrorOccurred
                                        ? '2px solid red'
                                        : '',
                                    fontSize: errors.mileageWhenErrorOccurred
                                        ? '16px'
                                        : '',
                                    textTransform:
                            ...
                            <FormTextArea
                                ...
                                optionalInputStyle={{
                                    border: errors.information
                                        ? '2px solid red'
                                        : '',
                                    fontSize: errors.information ? '16px' : '',
